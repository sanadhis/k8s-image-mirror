...
{{- define "k8s-image-mirror.kubectlVersion" -}}
{{- if .Values.images.kubectl.tag }}
...
{{- define "k8s-image-mirror.mirrorVersion" -}}
{{- if .Values.images.mirror.tag }}
{{- .Values.images.mirror.tag }}
{{- else }}
{{- .Chart.Version }}
{{- end }}
{{- end }}
